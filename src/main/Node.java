...
class Node {
    ...
    public void draw(Graphics2D g2d) {
        Color nodeColor;
        if (dragging) {
            nodeColor = new Color(255, 140, 0);
        } else if (highlighted) {
            nodeColor = new Color(50, 205, 50); // Lime Green untuk jalur
        } else {
        ...
        g2d.drawString(label, (int)(position.x - textWidth/2), (int)(position.y + textHeight/3));
    }
}